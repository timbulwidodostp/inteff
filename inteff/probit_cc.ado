...
program define probit_cc 
	...
	#delimit ;
  	preserve;
  		tempvar  _ieptst probit_cc _iepse x12 phat xbeta phi linear b1b4x2 			b2b4x1 deriv11 deriv22 deriv44 d2F d3F derivc deriv;
  		...
  		quietly {;
  			...
  			rename `probit_cc' `_pbt_cc';
    			...
    			gen `deriv44'= `phi' + _b[`x1x2']*`d2F'*`x1'*`x2' + 						`x2'*`b2b4x1'*`d2F'+ `x1'*`b1b4x2'*`d2F' +  
