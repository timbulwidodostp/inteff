...
program define probit_dd
  	...
  	preserve;
  		quietly {;
  			tempvar xbeta phat phi linear phat11 phat10 phat01 phat00 					probit_dd xbeta00 xbeta01 xbeta10 xbeta11 _ieltst _ielse 				deriv1 deriv2 deriv3 deriv0 phi_11 phi_10 phi_01 phi_00;
			...
			local nn= `nn'-1;
	    		...
	    		while `n'<=_N {;
	      		...
	      		matrix `VAR'=`mat123'*e(V)*`mat123'';     							scalar `var'=`VAR'[1,1];
